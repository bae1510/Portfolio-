...
function Footer() {
  return (
    ...
    <h4>Contact me</h4>
      ...
      <a href="https://github.com/bae1510" target="_blank" rel="noreferrer"
          title="Github">
      <BsGithub size={30} style={{color:"#808080", marginRight:"2rem"}}/>
      </a>
      <a href="https://www.linkedin.com/in/priyal-soni-a5b119168/" target="_blank" rel="noreferrer"
          title="linkden">
